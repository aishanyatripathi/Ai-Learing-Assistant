...
const DashboardPage = () => {
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Get started by uplaoding your first PDF document to begin
              learning.
            </p>
            <button 
  ...
  return (
    <div className=" min-h-screen">
      ...
      <div className="absolute inset-0 bgg-[radial-gradient(#e5e7eb_1px, transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none" />
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Manage and orgainze your learning materials
            </p>
          </div>
          {documents.length > 0 && (
        ...
        <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
          ...
          <form onSubmit={handleUpload} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-xs font-semibold texxt-slate-700 uppercase tracking-wide">
                Document Title
              </label>
              <input 
               type="text"
            ...
            <div className="space-y-2">
              ...
              <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                <input
                 id='file-upload'
                 type="file"
