...
import * as geminiServices from "../utils/geminiServices.js"
import { findRelevantChunks } from "../utils/textChunker.js";

//@desc    Generate Flashcard from document
//@route   POST /api/auth/generate-flashcards
//@access  Private
...
//@route   POST /api/auth/generate-quiz
//@access  Private
...
export const generateSummary = async (req, res, next) => {
    try {
        ...
        const summary = await geminiServices.generateSummary(document.extractedText);
...
export const chat = async (req, res, next) => {
    try {
        ...
        if(!documentId || !question) {
            return res.status(400).json({
                success: false,
                error: 'Please porvide documentId and question',
                statusCode: 400
            });
        }
...
export const explainConcept =async (req, res, next) => {
    try {
        ...
        res.status(200).json({
            ...
            message: 'Expalnation generated successfully'
        });
    } catch (error) {
        next(error)
    }
