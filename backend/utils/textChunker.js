...
export const  chunkText = (text, chunkSize = 500, overlap = 50)=> {
    ...
    //Clean text while preeserving paragraph structure
   ...
   //Try to split by paragraphs (singleor or double newlines)
...
export const findRelevantChunks = (chunks, query, maxChunks =3) => {
    ...
    .sort((a,b) => {
        ...
        if (matchedWords !== a.matchedWords) {
